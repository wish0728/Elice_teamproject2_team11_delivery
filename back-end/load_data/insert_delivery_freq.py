...
df_2020_1=pd.read_csv("../rawdata/시간-지역별배달주문건수/elicer_2020_1_col_name.csv")
df_2020_2=pd.read_csv("../rawdata/시간-지역별배달주문건수/elicer_2020_2_col_name.csv")
df_2021=pd.read_csv("../rawdata/시간-지역별배달주문건수/elicer_2021_col_name.csv")

df = pd.concat([df_2019, df_2020_1, df_2020_2, df_2021], ignore_index=True)
# print(df.tail())
for row in df.itertuples():
	# print(row.날짜, row.시간대, row.배달건수, row.광역시도, row.시군구, row.읍면동)
